...
export default function AIChat() {
  ...
  const [canvasView, setCanvasView] = useState<boolean>(false);
  ...
  return (
    <div className="w-3xl h-full flex flex-col items-center px-8 py-4 relative">

      <div className="absolute top-1 w-full">
        <Button className="w-fit bg-white" onClick={() => setCanvasView(!canvasView)}>canvas view</Button>
      </div>
      ...
      {/** INPUT CONTAINER */}
      <div className="border border-border rounded-2xl overflow-hidden w-3xl">
